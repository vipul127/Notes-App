...
const Toast = ({isShown, message, type, onClose}) => {
  ...
  return (
    <div className={`absolute transition-all origin-top duration-400 scale-y-5 ${isShown ? "opacity-100": "opacity-0"}`}>
      <div className={`min-w-52 bg-white border shadow-2xl rounded-md after:w-[5px] after:h-full ${type === "delete" ?" after:bg-red-500" : "after:bg-green-500"} 
                       after:absolute after:left-0 after:top-0 after:lounded-l-lg`}>
